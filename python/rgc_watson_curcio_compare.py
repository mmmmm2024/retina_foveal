...
# --- 3. Curcio & Allen (1990) の実測データ処理（Drasdoモデルによる変換） ---
...
# --- 5. Watson と Curcio の密度重ね描き（log-logプロット） ---
plt.figure(figsize=(7, 5))
...
# === グラフ2: Figure A3 相当（視軸補正後の子午線ごとの変換）===
plt.figure(figsize=(7, 5))
...
# --- Appendix A7: 面積補正係数 a(r₀)（単位: mm²/deg²）---xs
